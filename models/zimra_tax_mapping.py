...
class ZimraTaxMapping(models.Model):
    ...
    odoo_tax_id = fields.Many2one('account.tax', 'Odoo Tax')  # Removed duplicate and made not required initially
    ...
    ], string='Tax Type', required=True, default='Exempt')  # Changed default from empty string
    ...
    def _check_unique_tax_mapping(self):
        for record in self:
            ...
            if existing:
                # This should raise ValidationError, not return notification
